/**
 * module src: app/unbindCoupon.js
 * 点击Don't use coupons当前订单解绑coupon
**/
define('app/unbindCoupon', ['common/config','app/getPlaceOrder','app/getCouponInfo', 'checkoutflow/popupTip', 'checkoutflow/dataErrorLog'], function(CONFIG,getPlaceOrder, getCouponInfo, tip, dataErrorLog){
        //收集请求后端接口异常数据
    var dataErrorLog = new dataErrorLog({
        ...
        __params = {
            url: CONFIG.wwwURL + '/mobileApiWeb/order-Order-unbindCoupon.do',
            //url: 'addCoupon.json',
            data: {}
        };
    return {
         ...
         *
         * 接口地址：
         * /mobileWebApi/order-Order-unbindCoupon.do
         * 接口文档地址：
         * http://m.dhgate.com/mobileWebApi/order-Order-unbindCoupon.do
         *
         * 说明：
        ...
        **/
        parse: function(res) {
            ...
            if (obj.code !== -1) {
                var isUnbind = res.data.isUnbind;
                if(isUnbind==true){
                    //调用初始化接口
