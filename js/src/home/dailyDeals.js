/**
 * module src: home/dailyDeals.js
 * 每日优惠商品模块
**/
define('app/dailyDeals', ['common/config', 'lib/backbone', 'common/serverTime', 'appTpl/dailyDealsTpl'], function(CONFIG, Backbone, serverTime, tpl){
    //model-每日优惠商品
