/**
 * module src: common/turnToLanguagesWebsite.js
 * 获取当前页面url，根据选择的语言，跳转到对应的多语言站点页面
 **/
define('common/turnToLanguagesWebsite', ['common/config', 'lib/underscore', 'tpl/turnToLanguagesWebsiteTpl', 'tools/fastclick'], function(CONFIG, _, tpl, FastClick){
    return {
