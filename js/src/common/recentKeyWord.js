/**
 * module src: common/recentKeyWord.js
 * 页面顶部搜索：最近搜索关键词
 *
 * 说明：
 ...
 * 空间。
**/
define('common/recentKeyWord', ['common/config', 'lib/underscore', 'tpl/recentKeyWordTpl', 'tools/fastclick'], function(CONFIG, _, tpl, FastClick){
