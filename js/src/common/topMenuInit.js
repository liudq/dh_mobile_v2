/**
 * module src: common/topMenuInit.js
 * 顶部左侧菜单初始化模块
**/
define('common/topMenuInit', ['common/config', 'lib/backbone', 'tpl/topMenuInitTpl', 'tools/fastclick'], function(CONFIG, Backbone, tpl, FastClick){
    //model-顶部左侧菜单初始化
