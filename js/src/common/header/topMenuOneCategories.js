/**
 * module src: common/header/topMenuOneCategories.js
 * 顶部左侧菜单一级类目模块
**/
define('common/header/topMenuOneCategories', ['common/config', 'lib/backbone', 'tpl/header/topMenuOneCategoriesTpl', 'tools/fastclick'], function(CONFIG, Backbone, tpl, FastClick){
    //model-顶部左侧菜单一级类目
