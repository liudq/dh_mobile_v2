/**
 * module src: common/tpl/recommend/lastOneAndLastSecondTpl.js
 * 根据最后一次或倒数第二次浏览的产品进行推荐模板模块
**/
define('tpl/recommend/lastOneAndLastSecondTpl', [], function(){
    return {
        //主体内容
        main: [
            '<div class="viewed1">',
        ...
        title: [
            '<% var data = obj; %>',
            '<div class="pro-tit"><%=data.blockTit%></div>'
        ],
        //产品列表
        products: [
            '<% var data = obj; %>',
