//hammer.js为支持backbone的官方插件
//https://github.com/wookiehangover/backbone.hammer
...
(function(root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    define('tools/backbone.hammer', ['lib/underscore', 'lib/backbone', 'tools/jquery.hammer'], function(_, Backbone) {
      factory(_, Backbone);
    });
