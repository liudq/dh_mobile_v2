/**
 * module src: common/recommend/lastOneAndLastSecond.js
 * 根据最后一次或倒数第二次浏览的产品进行推荐模块
**/
define('common/recommend/lastOneAndLastSecond', ['common/config', 'tpl/recommend/lastOneAndLastSecondTpl', 'lib/underscore'], function(CONFIG, tpl, _){
    //构造函数
    var LastOneAndLastSecond = function(options) {
        //初始化配置对象
    ...
    //注册静态属性与方法
    $.extend(LastOneAndLastSecond,{
        init: function(options) {
            return new LastOneAndLastSecond(options);
        }
    });

    //注册原型属性与方法
    $.extend(LastOneAndLastSecond.prototype,{
        setOptions: function(options) {
            this.options = {
                ...
                api: {
                    //地址
                    url: CONFIG.wwwURL + '/mobileApiWeb/search-Recommend-getRecomByVisit.do',
                    //url: 'search-Recommend-getRecomByVisit.do',
                    //参数
                    param: {
                        //通用参数
                        client: 'wap',
        ...
        parse: function(res) {
             ...
             *
             * 接口地址：
             * /mobileApiWeb/search-Recommend-getRecomByVisit.do
