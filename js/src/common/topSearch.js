/**
 * module src: common/topSearch.js
 * 页面顶部搜索
 *
 * 说明：
 * 包含了，“最近搜索关键词”、“热门关键词”、
...
define('common/topSearch', ['common/config', 'common/recentKeyWord', 'common/hotKeyWord', 'common/suggest', 'tools/fastclick'], function(CONFIG, RecentKeyWord, HotKeyWord, Suggest, FastClick){
    //view-页面顶部搜索
    var TopSearchView = Backbone.View.extend({
        ...
        selectKeyWord: function(ev) {
            //(.+)(?:1|2|3)$ 去除末尾1|2|3这些多余内容
            this.$dSearchInput.val($(ev.currentTarget).find(this.cSearchKey).text());
            //搜索跳转
            this.jumpSearch();
        },
        //设置整个搜索展示样式
